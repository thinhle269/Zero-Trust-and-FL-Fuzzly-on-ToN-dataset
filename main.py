...
trainloaders, valloader, testloader, trainloader_centralized, input_size, num_classes, class_names = prepare_data(num_clients=NUM_CLIENTS)
...
#metrics_trust, cm_trust = get_predictions_and_metrics(trustfedavg_model, valloader, class_names)
#metrics_trust_tau, cm_trust_tau = get_predictions_and_metrics(trustfedavg_thr_model, valloader, class_names)
...
with pd.ExcelWriter("publication_results.xlsx") as writer:
    ...
    # Delta sheet
    df_delta = df_res["TrustFedAvg-Fuzzy(τ=0.20)"] - df_res["TrustFedAvg-Fuzzy"]
...
#plot_curve(axes[0,0], trustfedavg_history, trustfedavg_thr_history, "accuracy", "Accuracy vs Rounds")
#plot_curve(axes[0,1], trustfedavg_history, trustfedavg_thr_history, "macro_f1", "Macro-F1 vs Rounds")
...
plot_curve(axes[0,0], fedavg_history, trustfedavg_thr_history, "accuracy", "Accuracy vs Rounds")
plot_curve(axes[0,1], fedavg_history, trustfedavg_thr_history, "macro_f1", "Macro-F1 vs Rounds")
# Final metrics bar chart
#plot_final_metrics_bar_chart(axes[1,0], metrics_cent, metrics_fedavg, metrics_trust)
axes[1,0].set_title("Final Metrics (No τ)")

# Confusion matrix with τ
plot_confusion_matrix(axes[1,1], cm_trust_tau, class_names, f"Confusion Matrix - TrustFedAvg-Fuzzy (τ={TAU})")
...
plot_confusion_matrix(axes[1, 2], cm_trust, class_names, "Confusion Matrix - TrustFedAvg-Fuzzy")
# Trust dynamics
