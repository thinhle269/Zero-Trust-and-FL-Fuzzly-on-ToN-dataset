...
#trustfedavg_thr_model,trustfedavg_model, trustfedavg_history, trustfedavg_trust_history = run_simulation(mode="TrustFedAvg")
...
plot_final_metrics_bar_chart(axes[0, 2], metrics_cent, metrics_fedavg, metrics_trust)
